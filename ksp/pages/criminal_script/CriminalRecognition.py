...
class CriminalRecognition:
    ...
    def face_compare(self,img1,img2):
        ...
        face_loc_1 = face_recognition.face_locations(rgb_small_frame)
        face_encoding_1 = face_recognition.face_encodings(rgb_small_frame,face_loc_1)
        ...
        face_loc_2 = face_recognition.face_locations(rgb_small_frame_2)
        face_encoding_2 = face_recognition.face_encodings(rgb_small_frame_2,face_loc_2)
